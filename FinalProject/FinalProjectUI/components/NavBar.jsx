          ...
          <Collapse isOpen={isOpen} navbar>
            <Nav className="mr-auto" navbar data-testid="navbar-items">
              ...
              {user && (
                <>
                  <NavItem>
                    <PageLink href="/retro-templates" className="nav-link" testId="navbar-csr">
                      Retro Templates
                    </PageLink>
                  </NavItem>
                  <NavItem>
                    <PageLink href="/retrospectives" className="nav-link" testId="navbar-ssr">
                      Retrospectives
                    </PageLink>
                  </NavItem>
                </>
            ...
            >
              {isDarkMode ? <IconSun size="1.1rem" /> : <IconMoonStars size="1.1rem" />}
            </ActionIcon>
          </Collapse>
        </Container>
      </Navbar>
